...
| **DSU** (открытий приложения/день/пользователь) | ⚠️ **21** | По аналогии с Telegram: Павел Дуров, март 2025 ([\[3\]](#источники-2-3) — Ctrl+F: *"21 раз в день"*); данных MAX нет |
...
Логическая схема описывает сущности мессенджера MAX, их атрибуты и связи. Основана на паттерне Telegram MTProto Updates API ([\[3\]](#источники-5-3) — Ctrl+F: *"pts"* и *"getDifference"*): per-user журнал событий + курсор на каждом устройстве.
